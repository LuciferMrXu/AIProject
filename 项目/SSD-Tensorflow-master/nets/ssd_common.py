...
def tf_ssd_bboxes_encode_layer(labels, #ground truth标签，1D tensor
    ...
    """
    # Anchors coordinates and volume. # Anchors coordinates and volume.
    #获取anchors层
    ...
    # Initialize tensors...
    #xmax的shape为((38, 38, 1), (38, 38, 1), (4,), (4,))(38, 38, 4)
    ...
    def body(i, feat_labels, feat_scores,
        ...
        #mask符合IOU阈值要求，注意这里并没有使用 feat_score都为 0
        ...
        # Update values using mask. 式子右端label是groudTruth feat_labels
        # 得出符合条件的 38*38*4个框的anchor框对应groudTruth情况， 也即
        # 真实框也得有这么多label和分数【本来真实框只一个,现在为了编码，要演化
        # 出相同的数量，同时要反应出正样本和负样本的label与分数】
    ...
    # Encode features. feat_cy是groundTruth ,yref是anchor
