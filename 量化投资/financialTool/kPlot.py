...
kNum = len(df['close']) + 10#统计K线的数量，目前有18根K线 62
...
d = C - O#收盘价小于开盘价是阴线
l = len(d)
# plt.subplot(facecolor = (0.24, 0.24, 0.24))#@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@2
 #开始画下引线
for i in range(l):
#     plt.figure(1, figsize = (15, 10), facecolor=(0.9, 0.9, 0.9))#@@@@@@@@@@@@@@22
...
#     plt.figure(1, figsize = (15, 10), facecolor=(0.9, 0.9, 0.9))#@@@@@@@@@@@@@@@@@@@@@@@@@@2
