...
"""
运行命令：
python server_1.py --job_name=ps --task_index=0 (至少一个)
python server_1.py --job_name=ps --task_index=1
python server_1.py --job_name=work --task_index=0 (至少一个)
...
ps_hosts = ['192.168.0.109:33331', '192.168.0.109:33332']
work_hosts = ['192.168.0.109:33333', '192.168.0.109:33334']
