...
net=tflearn.regression(net,optimizer='adam',
               loss='categorical_crossentropy',learning_rate=0.001,metric='accuracy')

# 训练
model=tflearn.DNN(net,tensorboard_dir='./logs',checkpoint_path='./model/lstm/model_lstm',max_checkpoints=3,tensorboard_verbose=4)
